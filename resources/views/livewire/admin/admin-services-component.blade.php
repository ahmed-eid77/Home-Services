                                            ...
                                            @foreach ($services as $service)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" onclick="confirm('Are you sure, you wnat to delete this service?') || event.stopImmediatePropagation()" wire:click.prevent="deleteService({{ $service->id }})" style="margin-left: 10px"><i class="fa fa-times fa-2x text-danger"></i></a>
                                                    </td>
