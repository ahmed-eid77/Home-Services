                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent='updateSlide'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-contorl" name="title"
                                                    wire:model="title">
                                                @error('title')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" class="form-contorl-file" name="new image"
                                                    wire:model="newImage">
                                                @error('newImage')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                                @if ($newImage)
                                                    <img src="{{ $newImage->temporaryurl() }}" width="150" height="80">
                                                @else
                                                    <img src="{{ asset('images/slider') }}/{{ $image }}" width="150" height="80">
                                                @endif
                                            </div>
                                        </div>
