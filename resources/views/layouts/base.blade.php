                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+911234567890"><i class="fa fa-phone"></i> +02-01007642441</a></li>
                            <li><a href="mailto:contact@surfsidemedia.in"><i class="fa fa-envelope"></i>
                                    ahmedeed240@gmail.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            ...
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i> Egypt, Damietta</a></li>
                        </ul>
                    </div>
                            ...
                            @if (Auth::user()->utype == 'ADM')
                                <li class="login-form"> <a href="#" title="Register">My Account (Admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        ...
                                        <li><a href="{{ route('admin.all_services') }}">Services</a></li>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#">Egypt, Damietta</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:ahmedeed240@gmail.com">ahmedeed240@gmail.com</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+911234567890">+02-01007642441</a>
                            </li>
                        </ul>
                        <h3 style="margin-top: 10px">FOLLOW US</h3>
                        <ul class="social">
                            <li class="facebook"><span><i class="fa fa-facebook"></i></span><a href="https://www.facebook.com/profile.php?id=100006065861984"></a></li>
                            <li class="twitter"><span><i class="fa fa-twitter"></i></span><a href="https://twitter.com/ahmedraedeed"></a></li>
                            <li class="github"><span><i class="fa fa-instagram"></i></span><a href="https://github.com/ahmed-eid77"></a></li>
                        </ul>
                    </div>
                </div>
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+911234567890">+02-01007642441</a>
                            </li>
                        </ul>
